...
public class EMpdemoData {
	public static void main(String[] args) {
		...
		Map<String, Double> map1 = emps.stream().
		collect(Collectors.groupingBy(Employee::getGender,Collectors.averagingInt(Employee::getAge)));
		System.out.println(map1);
		
		//4- Get the details of Highest paid employee in the organization
		System.out.println("*******************\n");
		Optional<Employee> collect = emps.stream().collect(Collectors.maxBy(Comparator.comparingDouble(e->e.getSalary())));
		...
		System.out.println("***************\n");
		//1 st way
		emps.stream().filter(e->e.getYearOfJoining()>2015).forEach(e->System.out.println(e));
		
		// 2nd way
		System.out.println("---------------\n");
		emps.stream().filter(e->e.getYearOfJoining()>2015).map(e->e.getName()).forEach(e->System.out.println(e));
		
		//6 count the number of employee in each department
		System.out.println("*************\n");
		Map<String, Long> collect2 = emps.stream().collect(Collectors.groupingBy(Employee::getDepartment,Collectors.counting()));
		System.out.println(collect2);
		// 7 what is the average salary of each department
		System.out.println("************\n");
		Map<String, Double> collect3 = emps.stream().collect(Collectors.groupingBy(Employee::getDepartment,Collectors.averagingDouble(Employee::getSalary)));
